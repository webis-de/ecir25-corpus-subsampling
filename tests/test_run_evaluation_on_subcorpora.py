...
class TestRunEvaluationOnSubCorproa(unittest.TestCase):
    def test_run_evaluation_on_full_corpus(self):
        expected = {
            "ndcg@10": 0.4823834988625106,
            "skipped_qrels": 0,
            "unjudged@10": 0.013654618473895585,
            "ndcg@10-condensed": 0.4832171883700933,
        }
    ...
    def test_run_evaluation_10000_corpus(self):
        expected = {
            "ndcg@10": 0.019501021007547373,
            "skipped_qrels": 292862,
            "unjudged@10": 0.963855421686747,
            "ndcg@10-condensed": 0.22121655171874038,
        }
